.. meta::
   :description: Familiarize yourself with contributing to the Gateway API charm documentation.
...
.. note::
   ...
   See `CONTRIBUTING.md <https://github.com/canonical/gateway-api-integrator-operator/blob/main/CONTRIBUTING.md>`_
...
`source code on GitHub <https://github.com/canonical/gateway-api-integrator-operator>`_.
You may open a pull request with your documentation changes, or you can
`file a bug <https://github.com/canonical/gateway-api-integrator-operator/issues>`_
