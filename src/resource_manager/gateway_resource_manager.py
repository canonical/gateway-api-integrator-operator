...
import kubernetes.client.api.custom_objects_api
...
class GatewayResourceManager(
    ResourceManager[kubernetes.client.V1CustomResourceDefinition]
    ...
    def __init__(
        ...
        """
        self._ns = namespace
        self._client = kubernetes.client.CustomObjectsApi()
        self._labels = labels
