...
html_context = {
    ...
    "license": {
        "name": "Apache-2.0",
        "url": "https://github.com/canonical/gateway-api-integrator-operator/blob/main/LICENSE",
    },
}
...
llms_txt_description = textwrap.dedent(
    """\
    This is the documentation for the Gateway API integrator charm, a Juju charm that integrates Kubernetes workloads with the Gateway API.
    """
)
